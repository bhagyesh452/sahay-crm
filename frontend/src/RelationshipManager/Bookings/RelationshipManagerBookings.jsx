...
function RelationshipManagerBookingBox() {
    ...
    const relationshipManagerUserId = localStorage.getItem("relationshipManagerUserId")
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            //.log(tempData)
            const userData = tempData.find((item) => item._id === relationshipManagerUserId);
    ...
    return (
        <div>
            ...
            <AdminExecutiveNavbar relationshipManagerUserId={relationshipManagerUserId} /> */}
...
export default RelationshipManagerBookingBox