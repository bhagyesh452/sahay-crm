...
function EmployeeUnderDocsLeads({
    ...
    useEffect(() => {
        const fetchEmployeeData = async () => {
            ...
            const companyNumbers = underDocsData?.map(
            ...
            if (companyNumbers.length > 0) {
                ...
                try {
                    ...
                    const updatedGeneralLeads = underDocsData.map((company) => {
                    ...
                    setUnderDocsData(updatedGeneralLeads); // Update with enriched data
                } catch (err) {
                    console.log(err);
                } finally {
                    // setIsLoading(false);
