...
//                                 </td>
//                                 < td
//                                     key={`${company["Company Name"]}-${company["Company Number"]}-${index}`}>
//                                     <LuHistory
//                                         onClick={() => {
//                                             console.log("Clicked on:", company["Company Name"], company["Company Number"]); // Debug log
...
//                                             };
//                                             handleShowEmployeeInfo(employeeInfo); // Show employee info
//                                         }}
