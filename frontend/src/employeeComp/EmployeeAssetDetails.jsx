                  ...
                  <div>
                    <ul class="nav nav-tabs">
                      ...
                      {service?.requiredDocuments?.length !== 0 && <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#ReqDocuments">Required Documents</a>
                      </li>}
                      ...
                      {service?.documents?.length !== 0 && <li class="nav-item">
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane fade" id="ReqDocuments">
                        <div className='ES_assetsdtl_Linner'>
                          {/* <div className='ES_assetsdtl_Linner_h'>
