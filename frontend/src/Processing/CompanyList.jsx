...
//     <div className="card">
//       <div className="card-header search-date-header">
//         <div className="d-flex justify-content-between align-item-center searchfields" >
//           <div className="input-icon w-100 p-0 ">
//             <Select
...
//               className="form-control"
//             >
//               <option className="input-icon-addon" value={"companyName"}>Company Name</option>
//               <option className="input-icon-addon" value={"bookingDate"}>Booking Date</option>
//               {/* Add more fields as needed */}
//             </Select>
//           </div>
//           {searchDisplay && (
//             <div className="input-icon w-100 d-flex align-items-center justify-content-start">
//               <span className="input-icon-addon">
//                 <svg
