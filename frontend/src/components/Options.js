export const options = [
  ...
  { value: "Seed Funding Document Support", label: "Seed Funding Support" },
  ...
  { value: "Nidhi SSS Document Support", label: "Nidhi Seed Support Scheme" },
  { value: "Nidhi Prayash Yojna Document Support", label: "Nidhi Prayash Yojna" },
  { value: "NAIF Document Support", label: "NAIF" },
  { value: "Raftaar Document Support", label: "Raftaar" },
  { value: "CSR Funding", label: "CSR Funding" },
  {value : 'Stand-Up India Document Support' , label : 'Stand-Up India'},
  ...
  {value : 'MSME Hackathon Document Support' , label : 'MSME Hackathon'},
  {value : 'Gujarat Grant' , label : 'Gujarat Grant'},
  {value : 'CGTMSC' , label : 'CGTMSC'},
  {value : 'Income Tax Exemption Document Support' , label : 'Income Tax Exemption'},
  {value : 'Mudra Loan' , label : 'Mudra Loan'},
  {value : 'SIDBI Loan' , label : 'SIDBI Loan'},
  {value : 'Incubation Document Support' , label : 'Incubation Support'},
