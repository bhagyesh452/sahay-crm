export const options = [
  ...
  { value: "Seed Funding Document Support", label: "Seed Funding Document Support" },
  ...
  { value : "Chunauti Document Support" , label :"Chunauti Document Support"},
  { value: "Nidhi SSS Document Support", label: "Nidhi SSS Document Support" },
  { value: "Nidhi Prayash Yojna Document Support", label: "Nidhi Prayash Yojna Document Support" },
  { value: "NAIF Document Support", label: "NAIF Document Support" },
  { value: "Raftaar Document Support", label: "Raftaar Document Support" },
  { value: "CSR Funding", label: "CSR Funding" },
  {value : 'Stand-Up India Document Support' , label : 'Stand-Up India Document Support'},
  ...
  {value : 'MSME Hackathon Document Support' , label : 'MSME Hackathon Document Support'},
  {value : 'Gujarat Grant' , label : 'Gujarat Grant'},
  {value : 'CGTMSC' , label : 'CGTMSC'},
  {value : 'Income Tax Exemption Document Support' , label : 'Income Tax Exemption Document Support'},
  {value : 'Mudra Loan' , label : 'Mudra Loan'},
  {value : 'SIDBI Loan' , label : 'SIDBI Loan'},
  {value : 'Incubation Document Support' , label : 'Incubation Document Support'},
