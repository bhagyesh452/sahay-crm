                            ...
                            <div className="col-lg-12 d-flex align-items-center justify-content-between">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        checked={formData.DirectorDetails[index]?.IsMainDirector || false}
                                    ...
                                    <div className="col-lg-4">
                                        <div className="mt-2 mb-2">
                                            ...
                                            <Select
                                                ...
                                                isDisabled={isFormSuccessfullySubmitted}
                        ...
                        <div className="row">
                            <div className="col-lg-12 text-left">
                                <button
                                    ...
                                    style={{
                                        width: "100px",
                                        cursor: isFormSuccessfullySubmitted ? "not-allowed" : "pointer"
                                    }}
                                >
                                    Save
                                </button>
