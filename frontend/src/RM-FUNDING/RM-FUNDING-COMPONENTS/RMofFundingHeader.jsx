...
import RmFundingBell from "./RModFundingBell";
import RMofFundingNotification from "./RMofFundingNotification";


function RmofFundingHeader({ name, designation }) {
  return (
    <div>
      <header className="navbar navbar-expand-md d-print-none">
        <div className="container-xl">
          ...
          <div style={{ display: "flex", alignItems: "center" }} className="navbar-nav flex-row order-md-last">
            ...
            <RMofFundingNotification name={name} designation={designation} />
            <div
...
export default RmofFundingHeader