...
export default function RMofFundingNotification({name , designation}) {
...
const { rmFundingUserId } = useParams();
...
React.useEffect(()=>{
  ...
  const handleLogout = () => {
    ...
    // Clear the token from local storage based on the current page
      ...
      localStorage.removeItem("rmoffundingToken");
      
      navigate("/rmoffunding/login-rmoffunding");
