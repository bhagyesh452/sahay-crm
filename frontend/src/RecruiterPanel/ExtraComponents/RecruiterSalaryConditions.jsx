...
const RecruiterSalaryConditions = ({ empName, empEmail, firstMonthSalaryCondition ,refreshData , mainStatus}) => {
    const [charges, setCharges] = useState(firstMonthSalaryCondition);
    const secretKey = process.env.REACT_APP_SECRET_KEY;
    const [openEmailPopup, setOpenEmailPopup] = useState(false);

    const handleSubmitPortalCharges = async () => {
        try {
            const response = await axios.post(`${secretKey}/recruiter/post-save-firstMonthSalaryCondition`, {
                empName,
                empEmail,
                charges
            });
    ...
    return (
        <div>
            ...
            <div
                ...
                title={firstMonthSalaryCondition}
            >
                {!firstMonthSalaryCondition ? "Enter First Salary Condition" : firstMonthSalaryCondition}
            </div>
                ...
                <DialogContent>
                    <div className="card-footer">
                        <div className="remarks-input">
                            <input
                                type='email'
                                placeholder="Enter First Salary Condition"
...
export default RecruiterSalaryConditions;
