...
// function RecruiterLogin({ setRecruiterToken }) {
...
// e.preventDefault()
// try{
//     const response = await axios.post(`${secretKey}/recruiterlogin` , {
//         email,
//         password,
//         designation
//     })
...
//     localStorage.setItem("recruiterToken" , recruiterToken)
...
//                                 <h2 className="h2 text-center mb-4">RECRUITERLOGIN</h2>
...
function RecruiterLogin({ setRecruiterToken }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            localStorage.setItem("recruiterToken", recruiterToken)
            localStorage.setItem("recruiterUserId", recruiterUserId)
            navigate(`/recruiter/dashboard/${recruiterUserId}`)
                    ...
                    <div className="login-card">
                        <div className="row align-items-stretch">
                            ...
                            <div className="col-sm-6 p-0">
                                <div className="card card-md login-box">
                                    <div className="card-body">
                                        <h2 className="h2 text-center mb-4">Recruiter Login</h2>
