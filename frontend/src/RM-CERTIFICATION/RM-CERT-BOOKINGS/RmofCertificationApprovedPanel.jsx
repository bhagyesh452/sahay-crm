...
import NSWSMobileNo from "../Extra-Components/NSWSMobileNo.jsx";
                ...
                <tr className="tr-sticky">
                  ...
                  <th>
                    <div className="d-flex align-items-center justify-content-center position-relative">
                      ...
                      <div className="RM_filter_icon">
                        {rmServicesData.some(item => item.hasOwnProperty('otpVerificationStatus')) && ( // Check if the field exists in the data
                          <>
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        <ContentWriterDropdown
                          ...
                          writername={
                            obj.contentWriter ? obj.contentWriter : "RonakKumar"
                          }
                          refreshData={refreshData}
                        />
                      </td>
            ...
            {remarksHistory && remarksHistory.length === 0 && (
              <div class="card-footer">
                <div class="mb-3 remarks-input">
                  <textarea
                    placeApproveder="Add Remarks Here...  "
...
export default RmofCertificationApprovedPanel;
