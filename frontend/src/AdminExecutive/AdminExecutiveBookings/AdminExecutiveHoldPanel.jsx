...
function AdminExecutiveHoldPanel({ searchText, showFilter, activeTab, totalFilteredData, showingFilterIcon }) {
  ...
  const [newStatusHold, setNewStatusHold] = useState("Hold");
 ...
 const fetchData = async (searchQuery = "", page = 1, isFilter = false) => {
  ...
  return (
    <div>
      <div className="table table-responsive table-style-3 m-0" id="holdTable">
        {openBacdrop && (
          <Backdrop
                      ...
                      <div>
                        {obj.mainCategoryStatus && obj.subCategoryStatus && (
                          <DscStatusDropdown
                            ...
                            mainStatus={obj.mainCategoryStatus}
                            subStatus={obj.subCategoryStatus}
                            setNewSubStatus={setNewStatusHold}
                            companyName={obj["Company Name"]}
                            serviceName={obj.serviceName}
                            refreshData={refreshData}
...
export default AdminExecutiveHoldPanel;
