...
export default function AdminExecutiveNotification({name , designation}) {
...
const { adminExecutiveToken } = useParams();
const { adminExecutiveUserId } = useParams();
