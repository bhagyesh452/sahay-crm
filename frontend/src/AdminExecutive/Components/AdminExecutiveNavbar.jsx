          ...
          <div className="navbar">
            <div className="container-xl">
              <ul className="navbar-nav">
                <li className={
                  location.pathname === `/adminexecutive/dashboard/${adminExecutiveUserId}` ? "nav-item active" : "nav-item"
                }
                ...
                {/* <li
                  className={
                    location.pathname === `/adminexecutive/bookings/${adminExecutiveUserId}` ? "nav-item active" : "nav-item"
                  }
