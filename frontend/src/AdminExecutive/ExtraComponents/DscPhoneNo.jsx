...
const DscPhoneNo = ({ companyName, serviceName, dscPhoneNo ,refreshData , mainStatus}) => {
    ...
    const handleSubmitPortalCharges = async () => {
        try {
            const response = await axios.post(`${secretKey}/rm-services/post-save-phoneno-adminexecutive`, {
                companyName,
                serviceName,
                charges
            });
