...
function GraphicDesignerLogin({ setGraphicDesignerToken }) {
    ...
    const handleSendOtp = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`${secretKey}/verifyCredentials`, {
                email,
                password,
                designations: ["Graphic Designer"], // Send array of designations
            });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const loginResponse = await axios.post(`${secretKey}/graphicdesignerlogin`, {
                email,
                password,
                designation,
            });

            const { graphicDesignerToken, userId } = loginResponse.data;
            setGraphicDesignerToken(graphicDesignerToken);
            setUserId(userId);
            localStorage.setItem("graphicDesignerToken", graphicDesignerToken);
            localStorage.setItem("graphicDesignerUserId", userId);
            localStorage.setItem("graphicDesignerName", ename);
            navigate(`/graphic-designer/dashboard/${userId}`);
        } catch (error) {
