...
function Dashboard() {
  ...
  const handleChangeDate = (filter) => {
    ...
    if (filter === "by-week") {
      ...
      const lastMonth = new Date(today.getFullYear(), today.getMonth() - 1, today.getDate()); // Date 1 month ago
      ...
      const lastYear = new Date(today.getFullYear() - 1, today.getMonth(), today.getDate()); // Date 1 year ago
                    ...
                    <table>
                      ...
                      {finalFilteredData.length !== 0 ? (
                       ...
                       { finalFilteredData.map((obj, index) => (
                              ...
                              <td>
                                {
                                  ...
                                  obj.services[0]
                                    .split(",")
                                    .map((service) => service.trim()).length
                                }
                              </td>
                          ...
                          <tfoot>
                              <tr>
                                <td colSpan={2}>Total:{finalFilteredData.length}</td>
                               
                                <td>{filteredBooking.filter((data) => {
                                  return (
