...
router.put("/updateEmployeeDraft/:empId", upload.fields([
    ...
    const { empId } = req.params;
    const { firstName, middleName, lastName, dob, gender, personalPhoneNo, personalEmail, officialNo, officialEmail, joiningDate, branch, manager, firstMonthSalary, salaryCalculation, personName, relationship, personPhoneNo, activeStep } = req.body;
...
//     const employeementInfo = req.body.employeementInfo ? JSON.parse(req.body.employeementInfo) : {};
//     const payrollInfo = req.body.payrollInfo ? JSON.parse(req.body.payrollInfo) : {};
//     const emergencyInfo = req.body.emergencyInfo ? JSON.parse(req.body.emergencyInfo) : {};
