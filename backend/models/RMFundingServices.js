...
const RMFundingServicesSchema = new mongoose.Schema({
  "Company Name": {
    type: String,
    required:true,
  },
...
const RMFundingModel = mongoose.model("RmFundingModel", RMFundingServicesSchema)

module.exports = RMFundingModel;